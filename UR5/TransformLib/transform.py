...
def axis_angle_to_matrix(x, y, z):
    ...
    #s = math.sin(angle)
    #t = 1.0 - c
    #M = numpy.empty((3, 3), dtype=numpy.float64)
    #M[0][0] = c + x_norm*x_norm*t
    #M[1][1] = c + y_norm*y_norm*t
    #M[2][2] = c + z_norm*z_norm*t
    #tmp1 = x_norm*y_norm*t
    #tmp2 = z_norm*s
    #M[1][0] = tmp1 + tmp2
    #M[0][1] = tmp1 - tmp2
    #tmp1 = x_norm*z_norm*t
    #tmp2 = y_norm*s
    #M[2][0] = tmp1 - tmp2
    #M[0][2] = tmp1 + tmp2
    #tmp1 = y_norm*z_norm*t
    #tmp2 = x_norm*s
    #M[2][1] = tmp1 + tmp2
    #M[1][2] = tmp1 - tmp2
